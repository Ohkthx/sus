...
namespace SUSClient.Menus
{
    public abstract class Menu
    {
        ...
        private readonly Dictionary<string, Menu>
            m_SubMenus = new Dictionary<string, Menu>(); // Key: Text; Value: SubMenu to call.
        ...
        protected void ShowMenu()
        {
            ...
            if (m_Header != string.Empty) Console.WriteLine(m_Header + "\n");
            ...
            CreateFooter();
            if (m_Footer != string.Empty) Console.WriteLine("\n" + m_Footer);
        }
        ...
        private Menu(string header, string body)
        {
            m_Header = header;
            m_Body = body;
        }
        ...
        private void CreateFooter()
        {
            ...
            {
                if (n - 1 % MaxItemPerLine == 0 && n + 1 < m_SubMenus.Count) m_Footer += "\n"; // Add a new line.
